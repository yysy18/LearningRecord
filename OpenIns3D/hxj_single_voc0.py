...
def single_vocabulary_detection(path_3D_scans, vocabulary, path_masks= None, path_images = None,detector="odise"):
    ...
    snap_class = Snap([800, 800], [2, 0.5, 0.0], "output/hxj_snap_demo")
    ...
    if path_images:
        ...
        image = cv2.imread(os.path.join(path_images, name_of_scene, "image/image_rendered_angle_1.png"))
    ...
    if path_images:
        mask_classfication, score = lookup_class.lookup_pipelie(xyz_rgb, mask, name_of_scene, threshold = 0.6, use_2d=True, single_detection=False)
    else:
    ...
    print("mask_classficatio:",mask_classfication)
    print("score:",score)
