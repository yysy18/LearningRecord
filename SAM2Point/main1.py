...
def main():
    ...
    parser.add_argument('--dataset', choices=['my','S3DIS', 'ScanNet', 'Objaverse', 'KITTI', 'Semantic3D'], default='Objaverse', help='dataset selected')
    ...
    if args.dataset == 'S3DIS':
        ...
        info = configs.my_samples[args.sample_idx]
        point, color = dataset.load_my_sample(info['path'])
